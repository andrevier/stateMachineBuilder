...
int OpalSnapshot_Copy_DWork(void * src, void * dst) {
   ...
   eltSize = sizeof(pSrc->stateMachine);
   memcpy(&pDst->stateMachine, &pSrc->stateMachine, eltSize);
   size += eltSize;

   eltSize = sizeof(pSrc->stateMachine_i);
   memcpy(&pDst->stateMachine_i, &pSrc->stateMachine_i, eltSize);
   size += eltSize;

   eltSize = sizeof(pSrc->stateMachine_l);
   memcpy(&pDst->stateMachine_l, &pSrc->stateMachine_l, eltSize);
   size += eltSize;
   ...
   eltSize = sizeof(pSrc->stateMachine_not_empty);
   memcpy(&pDst->stateMachine_not_empty, &pSrc->stateMachine_not_empty, eltSize);
   size += eltSize;

   eltSize = sizeof(pSrc->stateMachine_not_empty_p);
   memcpy(&pDst->stateMachine_not_empty_p, &pSrc->stateMachine_not_empty_p, eltSize);
   size += eltSize;

   eltSize = sizeof(pSrc->stateMachine_not_empty_n);
   memcpy(&pDst->stateMachine_not_empty_n, &pSrc->stateMachine_not_empty_n, eltSize);
   size += eltSize;
