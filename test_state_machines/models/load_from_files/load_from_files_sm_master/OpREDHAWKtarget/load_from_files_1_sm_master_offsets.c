...
{
  OpalUnInitAdress();
  opalParametersAdressMapping = (void**)malloc(sizeof(void*) * 11);
  opalParametersSizeMapping = (uint32_t*)malloc(sizeof(uint32_t) * 11);
  opalParametersNumElementsMapping = (uint32_t*)malloc(sizeof(uint32_t) * 11);
  ...
  opalParametersAdressMapping[0] = (void*)&rtP.allEvents;
  opalParametersSizeMapping[0] = sizeof(rtP.allEvents[0]);
  opalParametersNumElementsMapping[0] = 25;
  opalParametersAdressMapping[1] = (void*)&rtP.encodedStates;
  opalParametersSizeMapping[1] = sizeof(rtP.encodedStates[0]);
  opalParametersNumElementsMapping[1] = 156;
  opalParametersAdressMapping[2] = (void*)&rtP.transitions;
  opalParametersSizeMapping[2] = sizeof(rtP.transitions[0]);
  ...
  opalParametersAdressMapping[5] = (void*)&rtP.SFunction_P1_Size;
  opalParametersSizeMapping[5] = sizeof(rtP.SFunction_P1_Size[0]);
  opalParametersNumElementsMapping[5] = 2;
  opalParametersAdressMapping[6] = (void*)&rtP.SFunction_P1;
  opalParametersSizeMapping[6] = sizeof(rtP.SFunction_P1);
  opalParametersNumElementsMapping[6] = 1;
  opalParametersAdressMapping[7] = (void*)&rtP.SFunction_P2_Size;
  opalParametersSizeMapping[7] = sizeof(rtP.SFunction_P2_Size[0]);
  opalParametersNumElementsMapping[7] = 2;
  opalParametersAdressMapping[8] = (void*)&rtP.SFunction_P2;
  opalParametersSizeMapping[8] = sizeof(rtP.SFunction_P2);
  opalParametersNumElementsMapping[8] = 1;
  opalParametersAdressMapping[9] = (void*)&rtP.SFunction_P1_Size_g;
  opalParametersSizeMapping[9] = sizeof(rtP.SFunction_P1_Size_g[0]);
  opalParametersNumElementsMapping[9] = 2;
  opalParametersAdressMapping[10] = (void*)&rtP.SFunction_P1_l;
  opalParametersSizeMapping[10] = sizeof(rtP.SFunction_P1_l);
  ...
  opalSignalsAdressMapping[2] = (void*)&rtB.SFunction_o;
  opalSignalsSizeMapping[2] = sizeof(rtB.SFunction_o);
