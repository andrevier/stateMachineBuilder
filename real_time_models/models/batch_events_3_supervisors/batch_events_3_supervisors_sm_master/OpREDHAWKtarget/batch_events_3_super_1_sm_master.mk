...
MODEL           = batch_events_3_super_1_sm_master
MODULES         = rt_matrx.c rt_printf.c rt_logging.c batch_events_3_super_1_sm_master_data.c batch_events_3_super_1_sm_master_offsets.c rtGetInf.c rtGetNaN.c rt_nonfinite.c OP_SEND.c RECV_Param.c
MAKEFILE        = batch_events_3_super_1_sm_master.mk
MATLAB_ROOT     = F:
ALT_MATLAB_ROOT = F:
SOLVER          = 
NUMST           = 1
...
NCSTATES        = 0
COMPUTER        = PCWIN64
BUILDARGS       =  EXT_MODE=0 EXTMODE_STATIC_ALLOC=0 TMW_EXTMODE_TESTING=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 INCLUDE_MDL_TERMINATE_FCN=1 OPTS="-DTID01EQ=0"
MULTITASKING    = 0
MAT_FILE        = 1
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = batch_events_3_super_1_sm_master_ref.rsp
...
ifeq ($(OP_MATLABR2022A),1)
	MATLAB_INCLUDES += -I$(TARGET_MATLAB_ROOT)/toolbox/physmod/simscape/simtypes/core/c/win64 \
	-I$(TARGET_MATLAB_ROOT)/toolbox/physmod/simscape/ds/core/c/win64 \
	-I$(TARGET_MATLAB_ROOT)/toolbox/physmod/common/logging/core/c/win64
endif
...
ifeq ($(OP_MATLABR2021A),1)
MATLABVERSION_CFLAGS = -DOP_MATLABR2021A
endif
ifeq ($(OP_MATLABR2021B),1)
MATLABVERSION_CFLAGS = -DOP_MATLABR2021B
endif
ifeq ($(OP_MATLABR2022A),1)
MATLABVERSION_CFLAGS = -DOP_MATLABR2022A
endif
