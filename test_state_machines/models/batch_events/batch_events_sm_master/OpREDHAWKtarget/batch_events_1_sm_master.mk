...
MODEL           = batch_events_1_sm_master
MODULES         = rt_matrx.c rt_printf.c rt_logging.c batch_events_1_sm_master_data.c batch_events_1_sm_master_offsets.c rtGetInf.c rtGetNaN.c rt_nonfinite.c OP_SEND.c RECV_Param.c
MAKEFILE        = batch_events_1_sm_master.mk
MATLAB_ROOT     = F:
ALT_MATLAB_ROOT = F:
SOLVER          = 
NUMST           = 1
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = batch_events_1_sm_master_ref.rsp
